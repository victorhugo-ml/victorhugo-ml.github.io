...
const translations = {
  pt: {
    ...
    paysim: "Projeto exploratório de estudo: usei uma amostra estrutural de 1.000 transações para praticar SQL, análise de dados e grafos direcionados.",
  ...
  en: {
    ...
    paysim: "Exploratory study project: I used a structural sample of 1,000 transactions to practice SQL, data analysis, and directed graphs.",
  ...
  es: {
    ...
    paysim: "Proyecto exploratorio de estudio: usé una muestra estructural de 1.000 transacciones para practicar SQL, análisis de datos y grafos dirigidos.",
