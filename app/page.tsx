...
const translations = {
  pt: {
    ...
    paysim: "Projeto exploratório de estudo desenvolvido na disciplina Comunicação e Redes (UFABC, 2026): usei uma amostra estrutural de 1.000 transações para praticar SQL, análise de dados e grafos direcionados.",
  ...
  en: {
    ...
    paysim: "Exploratory study project developed for the Communication and Networks course (UFABC, 2026): I used a structural sample of 1,000 transactions to practice SQL, data analysis, and directed graphs.",
  ...
  es: {
    ...
    paysim: "Proyecto exploratorio de estudio desarrollado en la asignatura Comunicación y Redes (UFABC, 2026): usé una muestra estructural de 1.000 transacciones para practicar SQL, análisis de datos y grafos dirigidos.",
